        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-custom  example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" action="{{route('admin.lecture.store')}}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="file" name="thumbnail" accept="image/jpeg,image/gif,image/png," class="form-control" required />
                                </div>
                                <div class="col-lg-6">
                                    <label>Lecture Video:</label>
                                    <input type="file" name="file" accept="video/mp4" class="form-control" required />
                                </div>
                            </div>
